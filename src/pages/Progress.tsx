  ...
  useEffect(() => {
    async function fetchStats() {
      ...
      try {
        ...
        // Fetch lesson attempts for accuracy
  ...
  return (
    <div className="container py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Track your Spanish learning journey</p>
      </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-streak">{profile?.streak_days || 0}</p>
                <p className="text-xs text-muted-foreground">days</p>
              </div>
              <div className="h-12 w-12 rounded-full bg-streak/10 flex items-center justify-center">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-xp">{profile?.xp_points || 0}</p>
                <p className="text-xs text-muted-foreground">points</p>
              </div>
              <div className="h-12 w-12 rounded-full bg-xp/10 flex items-center justify-center">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">of {stats.totalLessons}</p>
              </div>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">{Math.round(lessonsProgress)}%</span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div className="text-center p-4 bg-muted/50 rounded-lg">
                <p className="text-2xl font-bold text-primary">{stats.lessonsCompleted}</p>
                <p className="text-xs text-muted-foreground">Completed</p>
              </div>
              <div className="text-center p-4 bg-muted/50 rounded-lg">
                <p className="text-2xl font-bold">{stats.totalLessons - stats.lessonsCompleted}</p>
          ...
          <CardContent className="space-y-4">
              ...
              <div className="relative inline-flex items-center justify-center">
                <svg className="h-32 w-32 -rotate-90">
                  ...
                  <circle
                    ...
                    strokeWidth="12"
                    strokeLinecap="round"
                    strokeDasharray={`${(stats.quizAccuracy / 100) * 352} 352`}
                  />
                </svg>
            ...
            <div className="flex justify-center gap-4">
              <Badge variant="secondary" className="gap-1">
                ...
                {stats.speakingAttempts} speaking attempts
              </Badge>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="text-center py-6">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                {profile?.level === "beginner" 
                  ? "Just getting started — ¡Buen comienzo!"
                  : profile?.level === "intermediate"
                    ? "Making great progress — ¡Muy bien!"
                    : "Impressive skills — ¡Increíble!"}
              </p>
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                <span className="text-sm">Verb conjugations</span>
                <Badge variant="secondary">Review</Badge>
              </div>
              <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                <span className="text-sm">Articles (el/la)</span>
